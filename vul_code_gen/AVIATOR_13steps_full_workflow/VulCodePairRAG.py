...
class ChromaVulCodePairRAG(RAG):
    ...
    def _load_embedding_model(self) -> HuggingFaceEmbeddings:
        ...
        Falls back to CPU on CUDA/NVML errors.
        """
        ...
        try:
            ...
            if "NVML" in str(e) or "cuda" in str(e).lower() or "CUDACachingAllocator" in str(e):
                logger.warning("CUDA/NVML error, falling back to CPU: %s", e)
